<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="CreateBankAccount.aspx.cs" Inherits="CreateBankAccount" %>
    ...
    <tr>
        ...
        <td style="text-align: left">
            <asp:TextBox ID="TextBox2" runat="server" style="text-align: left" 
                Width="168px" AutoPostBack="True" CausesValidation="True"></asp:TextBox>
        &nbsp;&nbsp;
            &nbsp;
            </td>
    </tr>
    ...
    <tr>
        ...
        <td class="style9" style="text-align: left">
            <asp:DropDownList ID="DropDownList2" runat="server">
                <asp:ListItem>Conventional</asp:ListItem>
